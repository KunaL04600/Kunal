...
while True:
    ...
    print_random_color("\nCreated by Kunal")
    print_random_color("⊛✴✹❋❀✿✽❁✺✻✼✾")
    print_random_color("Hello Guys, I'm Kunal & This is my First Project in Python, I Hope you Like it...!!!")
    print_random_color("\nConnect with me:\n")
    print_random_color("Instagram: https://www.instagram.com/offi.cial_20/n")
    print_random_color("Github: https://github.com/kunal04600\n")
